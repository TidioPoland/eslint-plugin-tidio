...
const reactRules = {
  // React
  "rulesdir/imports-order-for-less-files": 2,
  "rulesdir/imports-order-for-media-files": 2,
  "rulesdir/eslint-plugin-disallow-null-in-tenary-in-jsx": 2,
...
const reactOverrides = [
  {
    files: ["**/*.jsx", "*.tsx"],
    rules: {
      "rulesdir/always-require-default-export": 2,
    },
  },
  {
    files: [
    ...
    rules: {
      "rulesdir/always-require-default-export": 0,
    },
  },
  {
    files: ["**/*.tsx", "**/*.ts"],
