...
const reactRules = {
  // React
  "tidio-additional-rules/imports-order-for-less-files": 2,
  "tidio-additional-rules/imports-order-for-media-files": 2,
  "tidio-additional-rules/eslint-plugin-disallow-null-in-tenary-in-jsx": 2,
...
const reactOverrides = [
  {
    files: ["**/*.jsx", "*.tsx"],
    rules: {
      "tidio-additional-rules/always-require-default-export": 2,
    },
  },
  {
    files: [
    ...
    rules: {
      "tidio-additional-rules/always-require-default-export": 0,
    },
  },
  {
    files: ["**/*.tsx", "**/*.ts"],
